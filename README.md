...
每天马来西亚时间 06:17 和 18:47 自动扫描 2027 关西樱花季 KUL↔KIX、SIN↔KIX 往返机票，更新 `docs/` 下的网页（GitHub Pages）。

- 扫描：`scraper/scan.py`（Google Flights，经 `fast-flights`），GitHub Actions 每天 22:17 与 10:47 UTC 运行
